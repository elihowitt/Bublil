...
render::specialties::GUI::GUI(const std::string& texfile, const glm::vec2& position, const glm::vec2& scale, const std::string& shaderFile)
{
...
void render::specialties::GUI::update(const glm::vec2 & position, const glm::vec2 & scale)
{
	m_position = position;
	m_scale = scale;
}

void render::specialties::GUI::render()
{
	bind(0);
	...
	((render::shaders::GUIShader*)shader)->update(pack);
