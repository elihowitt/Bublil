...
phy::col::CollisionBody::CollisionBody(const COLLISIONBODYTYPE& type_, const bool isStatic_,
...
phy::col::CollisionBody::CollisionBody(const CollisionBody & other)
{
...
phy::col::CollisionBody::~CollisionBody()
{
	switch (CBT_type)
	{
	case phy::col::CBT_POINT:
...
phy::col::CollisionBody & phy::col::CollisionBody::operator=(const CollisionBody & rhs)
{
...
phy::col::CollisionBody phy::col::CollisionBody::getSphere()const
{
	...
	case phy::col::CBT_SKELETON:
		...
		return CollisionBody(CBT_SPHERE, isStatic, new glm::vec3(0,0,0), new float(sqrt(*disSquared)), nullptr, nullptr, nullptr, nullptr);
	case phy::col::CBT_SPHERE:
		break;
	default:
		break;
